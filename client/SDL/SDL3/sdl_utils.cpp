...
const char* sdl_event_type_str(Uint32 type)
{
	switch (type)
	{
		...
		EV_CASE_STR(SDL_EVENT_WINDOW_HDR_STATE_CHANGED); // https://github.com/libsdl-org/SDL/commit/2f276a2eea6a53b297e19bc7295f9fe114c74530
		...
		// https://github.com/libsdl-org/SDL/pull/10167
